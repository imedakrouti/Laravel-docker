<div class="modal fade" id="myModalrev" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <form id="userFormrev">
                <div class="modal-body">
                    ...
                    <div class="form-group" style="display: none;">
                        ...
                        <input class="form-control" type="text" id="account_type" name="account_type" value="3">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="seniority" name="seniority">
                    </div>
