<div class="modal fade" id="editModalrev" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Modifier le Revendeur</h4>

            </div>
            <form id="editFormrev">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="edit_username">edit_username:</label>
