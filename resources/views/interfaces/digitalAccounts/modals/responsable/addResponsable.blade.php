<div class="modal fade" id="myModalres" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="userFormres">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <button type="button" id="togglePasswordButtonAddResponsable" class="btn btn-outline-secondary" onclick="togglePasswordVisibility()">
                    ...
                    <div class="form-group">
                        <label for="account_type">User Agent:</label>
                        <select class="form-control" id="account_type" name="account_type">
                            <option value="0" selected>Administrateur</option>
                            <option value="1">QVT</option>
                ...
                <div id="errorMessageres" style="color: red; display: none;"></div>
