<div class="modal fade" id="editModalc" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Modifier un Enfant</h4>
      ...
      <form id="editFormc">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-outline-secondary" id="retourButtonc">Fermer</button>
        </div>
      </form>
    </div>
  </div>
